                      ...
                      <tbody>
                        <?php foreach ($repairforms as $form): ?>
                          <tr>
                            ...
                            <td>
                              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#statusModal<?= $form['id'] ?>">
                                เปลี่ยนสถานะ
                              </button>
                              <form action="repair_status_delete.php" method="POST" onsubmit="return confirm('ต้องการลบฟอร์มแจ้งซ่อมนี้หรือไม่')" style="display: inline"> 
                          ...
                          <div id="statusModal<?= $form['id'] ?>" class="modal fade" role="dialog">
                                  ...
                                  <form action="repair_status_delete.php" method="post">
                                    <div class="form-group" style="margin-bottom: 2rem">
                                      ...
                                      <select name="newstatus" class="form-control">
                                        <option value="1"<?= $form['Status'] == 1 ? ' selected' : ''?>>รอซ่อม</option>
                                        <option value="2"<?= $form['Status'] == 2 ? ' selected' : ''?>>ซ่อมเสร็จ</option>
                                      </select>
                                      <input type="hidden" name="id" value="<?= $form['id'] ?>">
                                    </div>
                                    <button type="submit" name="repair" class="btn btn-primary">แก้ไข</button>
