                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                  <div class="row">
                                    <div class="col-lg-12">
                                  <hr>
                                  <font color ="#0080ff"><h2 class="intro-text text-center">การเพิ่มอาคารที่พัก</h2></font>
                                  <hr>
                                   </div>
                                      <div class="col-lg-6">
                                          ...
                                          <form role="form" action= "building_insert.php" method="post">
                                              ...
                                              <div class="form-group">
                                                  <label>เพิ่มชื่ออาคารที่พัก</label>
                                                  <input class="form-control" name= "build1">
                                                  <p class="help-block">ตัวอย่าง : แฟลตกันเกรา 1</p>
                                              </div>

                                              <div class="form-group">
                                                  <label>เพิ่มจำนวนห้อง</label>
