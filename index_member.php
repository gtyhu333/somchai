        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <div class="col-md-5">
                        <table class="table">
                            <tr><td>ค่าน้ำ</td><td><?= $bills['water_total'] ?> บาท</td></tr>
                            <tr><td>ค่าไฟ</td><td><?= $bills['electric_total'] ?> บาท</td></tr>
                            <tr><td>ค่าห้อง</td><td><?= $bills['room_price'] ?> บาท</td></tr>
                            <tr><td>รวม</td><td><b><?= $bills['total'] ?> บาท</b></td></tr>
                        </table>
                    </div>
                    <?php else: ?>
                    <h4 class="text-success">ไม่มีค่าใช้จ่ายค้างชำระ</h4>
                    <?php endif; ?>
                </div>
            </div>
        </div>
